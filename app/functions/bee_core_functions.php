...
function get_css_framework_scripts()
{
	...
	switch ($framework) {
		...
		case 'bs53':
		default:
			$cdn = 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js';
			break;
	}
...
function get_vuejs($runtime = false)
{
	...
	$placeholder = '<script src="%s"></script>';
	$cdn         = is_local() ? 'https://unpkg.com/vue@next' : ($runtime === true ? 'https://cdnjs.cloudflare.com/ajax/libs/vue/3.0.11/vue.runtime.global.prod.js' : 'https://cdnjs.cloudflare.com/ajax/libs/vue/3.0.11/vue.global.prod.js');
