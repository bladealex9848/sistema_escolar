...
// Definir el uso horario o timezone del sistema de mexico
// date_default_timezone_set('America/Mexico_City');

// Definir el uso horario o timezone del sistema de Colombia
...
// Utilidades
define('CSS_FRAMEWORK', 'bs53'); // opciones disponibles: bs, bs5 o bs53 = Bootstrap 5 | bl = Bulma | fn = Foundation
...
define('BEE_USERS_TABLE', 'usuarios');         // Nombre de la tabla para autenticación de usuarios
